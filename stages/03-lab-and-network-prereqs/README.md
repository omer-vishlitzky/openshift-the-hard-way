# Stage 03: Lab and Network Prereqs
...
- 1 DNS service (can be external, lab local, or enterprise DNS)
...
- `api.<cluster>.<base_domain>`: API load balancer VIP (external and internal resolution)
...
- `stages/03-lab-and-network-prereqs/examples/haproxy.cfg`
- `stages/03-lab-and-network-prereqs/examples/keepalived.conf`
